...
export function Sheet({ title, onClose, children, footer }: SheetProps) {
  ...
  return createPortal(
    <div
      className="animate-fade fixed inset-0 z-50 flex items-end justify-center bg-black/45 backdrop-blur-[2px] sm:items-center sm:p-6"
      onClick={onClose}
      role="presentation"
    >
      <div
        ...
        className="animate-sheet flex max-h-[92dvh] w-full flex-col overflow-hidden rounded-t-5xl border border-line bg-surface shadow-sheet sm:max-w-lg sm:rounded-5xl"
      >
        <div className="shrink-0 px-6 pb-4 pt-3">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              ...
              onClick={onClose}
              aria-label="Close"
              className="grid size-9 place-items-center rounded-full text-muted transition hover:bg-accent-wash hover:text-ink active:scale-90"
            >
